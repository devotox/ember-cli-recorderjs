...
"function"==typeof u&&u[Y]?n[a]=u:s[H]&&(n[a]=new kt(s,u)),i[a]=s,r[a]=u}return r.attrs=n,r}var Ot=(0,a.symbol)("REF"),kt=function(){function e(e,t){this[c.MUTABLE_CELL]=!0,this[Ot]=e,this.value=t}return e.prototype.update=function(e){this[Ot][H](e)},e}()
...
o>0&&(r.writeWatching(t,o-1),1===o&&r.writableChains(be).remove(t))}}function Ce(e,t,n){g(t)?Te(e,t,n):Y(e,t,n)}function Se(e,t){var n=(0,i.peekMeta)(e)
...
e.default=Oe}),t("ember")}(),function(e){if("object"==typeof exports&&"undefined"!=typeof module)module.exports=e()
else if("function"==typeof define&&define.amd)define([],e)
else{("undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:this).Recorder=e()}}(function(){return function e(t,n,r){function i(a,s){if(!n[a]){if(!t[a]){var u="function"==typeof require&&require
if(!s&&u)return u(a,!0)
if(o)return o(a,!0)
...
var i,o=e("inline-worker"),a=(i=o)&&i.__esModule?i:{default:i}
var s=n.Recorder=function(){function e(t,n){var r=this;(function(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")})(this,e),this.config={bufferLen:4096,numChannels:2,mimeType:"audio/wav"},this.recording=!1,this.callbacks={getBuffer:[],exportWAV:[]},Object.assign(this.config,n),this.context=t.context,this.node=(this.context.createScriptProcessor||this.context.createJavaScriptNode).call(this.context,this.config.bufferLen,this.config.numChannels,this.config.numChannels),this.node.onaudioprocess=function(e){if(r.recording){for(var t=[],n=0;n<r.config.numChannels;n++)t.push(e.inputBuffer.getChannelData(n))
r.worker.postMessage({command:"record",buffer:t})}},t.connect(this.node),this.node.connect(this.context.destination)
var i={}
this.worker=new a.default(function(){var e=0,t=[],n=void 0,r=void 0
function o(){for(var e=0;e<r;e++)t[e]=[]}function a(e,t){for(var n=new Float32Array(t),r=0,i=0;i<e.length;i++)n.set(e[i],r),r+=e[i].length
return n}function s(e,t,n){for(var r=0;r<n.length;r++)e.setUint8(t+r,n.charCodeAt(r))}i.onmessage=function(u){switch(u.data.command){case"init":l=u.data.config,n=l.sampleRate,r=l.numChannels,o()
break
case"record":(function(n){for(var i=0;i<r;i++)t[i].push(n[i])
e+=n[0].length})(u.data.buffer)
break
case"exportWAV":(function(o){for(var u=[],l=0;l<r;l++)u.push(a(t[l],e))
var c=void 0
c=2===r?function(e,t){var n=e.length+t.length,r=new Float32Array(n),i=0,o=0
for(;i<n;)r[i++]=e[o],r[i++]=t[o],o++
return r}(u[0],u[1]):u[0]
var h=(p=c,d=new ArrayBuffer(44+2*p.length),m=new DataView(d),s(m,0,"RIFF"),m.setUint32(4,36+2*p.length,!0),s(m,8,"WAVE"),s(m,12,"fmt "),m.setUint32(16,16,!0),m.setUint16(20,1,!0),m.setUint16(22,r,!0),m.setUint32(24,n,!0),m.setUint32(28,4*n,!0),m.setUint16(32,2*r,!0),m.setUint16(34,16,!0),s(m,36,"data"),m.setUint32(40,2*p.length,!0),function(e,t,n){for(var r=0;r<n.length;r++,t+=2){var i=Math.max(-1,Math.min(1,n[r]))
e.setInt16(t,i<0?32768*i:32767*i,!0)}}(m,44,p),m),f=new Blob([h],{type:o})
var p,d,m
i.postMessage({command:"exportWAV",data:f})})(u.data.type)
break
case"getBuffer":(function(){for(var n=[],o=0;o<r;o++)n.push(a(t[o],e))
i.postMessage({command:"getBuffer",data:n})})()
break
case"clear":e=0,t=[],o()}var l}},i),this.worker.postMessage({command:"init",config:{sampleRate:this.context.sampleRate,numChannels:this.config.numChannels}}),this.worker.onmessage=function(e){var t=r.callbacks[e.data.command].pop()
"function"==typeof t&&t(e.data.data)}}return r(e,[{key:"record",value:function(){this.recording=!0}},{key:"stop",value:function(){this.recording=!1}},{key:"clear",value:function(){this.worker.postMessage({command:"clear"})}},{key:"getBuffer",value:function(e){if(!(e=e||this.config.callback))throw new Error("Callback not set")
...
r.configurable=!0,r.value&&(r.writable=!0)}Object.defineProperties(e,t)}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),r=function(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")},i=!!(e===e.window&&e.URL&&e.Blob&&e.Worker),o=function(){function t(n,o){var a=this
if(r(this,t),i){var s=n.toString().trim().match(/^function\s*\w*\s*\([\w\s,]*\)\s*{([\w\W]*?)}$/)[1],u=e.URL.createObjectURL(new e.Blob([s],{type:"text/javascript"}))
return new e.Worker(u)}this.self=o,this.self.postMessage=function(e){setTimeout(function(){a.onmessage({data:e})},0)},setTimeout(function(){n.call(o)},0)}return n(t,{postMessage:{value:function(e){var t=this
...
return{default:self.Recorder,__esModule:!0}})}(),define("ember-cli-recorderjs/services/recorder",["exports","Recorder"],function(e,t){"use strict"
...
var i=window,o=i.URL,a=(i.Blob,i.Promise),s=i.navigator,u=i.FileReader,l=i.AudioContext,c=function(e){return o.createObjectURL(e)},h=function(e){var t="data"===(arguments.length>1&&void 0!==arguments[1]?arguments[1]:"text")?"readAsDataURL":"readAsText"
return new a(function(n,r){var i=new u
i[t](e),i.onerror=function(e){return r(e)},i.onload=function(){return n(i.result)}})},f=Ember.Service.extend({recorder:null,isRecording:!1,audioTimeout:null,audioContext:null,recordingTime:5e3,audioElementType:"audio/wav",audioElementID:"audio-playback",init:function(){return this._super.apply(this,arguments),this.setup()},setup:function(){var e=r(regeneratorRuntime.mark(function e(){var t,n,r=this
return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return t=this.get("recorder"),n=this.get("audioContext"),e.abrupt("return",n&&t||s.mediaDevices.getUserMedia({audio:!0}).then(function(e){r.createNewRecorder(e)}))
case 3:case"end":return e.stop()}},e,this)}))
return function(){return e.apply(this,arguments)}}(),createNewRecorder:function(){var e=r(regeneratorRuntime.mark(function e(n){var r,i,o
return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return r=this.get("audioContext")||this.set("audioContext",new l),i=r.createMediaStreamSource(n),o=new t.default(i),this.set("recorder",o),e.abrupt("return",o)
case 5:case"end":return e.stop()}},e,this)}))
return function(t){return e.apply(this,arguments)}}(),stop:function(){var e=r(regeneratorRuntime.mark(function e(){var t,n
...
case 10:return t=this.get("recordingTime"),n=this.get("recorder"),this.set("isRecording",!0),n.record(),e.abrupt("return",t&&new a(function(e,n){var i=Ember.run.later(function(){return e(r.stop())},t)
r.set("audioTimeout",i),r.set("resolvePromise",e),r.set("rejectPromise",n)}))
case 15:case"end":return e.stop()}},e,this,[[0,7]])}))
return function(){return e.apply(this,arguments)}}(),getAudio:function(){var e=r(regeneratorRuntime.mark(function e(){var t
return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:if(t=this.get("recorder")){e.next=3
break}throw new Error("Recorder not initialized")
case 3:return e.next=5,new a(function(e){t.exportWAV(function(t){var n=c(t)
h(t,"data").then(function(r){e({blob:t,base64:r,audioURL:n})})})})
...
case 3:t=e.sent,n=t.audioURL,r=document.createElement("audio"),(i=document.createElement("source")).src=n,i.type=this.audioElementType,r.autoplay=!0,r.id=this.audioElementID,r.addEventListener("ended",this.removeAudioElement.bind(this)),r.appendChild(i),document.body.appendChild(r)
...
return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:this.removeAudioElement(),t=this.get("audioTimeout"),n=this.get("rejectPromise"),t&&Ember.run.cancel(t),n&&n(new Error("Recorder Reset")),this.resetRecorder(),this.clear()
case 7:case"end":return e.stop()}},e,this)}))
return function(){return e.apply(this,arguments)}}(),close:function(){var e=r(regeneratorRuntime.mark(function e(){var t
...
case 6:case"end":return e.stop()}},e,this)}))
return function(){return e.apply(this,arguments)}}(),removeAudioElement:function(){var e=document.getElementById(this.audioElementID)
...
e&&e.stop()},clear:function(){var e=this.get("recorder")
e&&e.clear(),e&&e.stop()}})
e.default=f}),define("ember-load-initializers/index",["exports"],function(e){"use strict"
