...
return new Promise(function(e,r){function n(o,i){try{var a=t[o](i),u=a.value}catch(e){return void r(e)}if(!a.done)return Promise.resolve(u).then(function(e){n("next",e)},function(e){n("throw",e)})
...
e.set("recorder",t)},actions:{record:function(){var e=t(regeneratorRuntime.mark(function e(){var t,r,n,o,i
return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return t=this.get("recorder"),e.next=3,t.record()
case 3:return e.next=5,t.getAudio()
case 5:r=e.sent,n=r.base64,o=r.audioURL,i=r.blob,console.log(n,o,i)
